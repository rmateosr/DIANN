...
#meltselected_normalizednumericoutputDIANN = melt(selected_normalizednumericoutputDIANN)
...
meltselected_normalizednumericoutputDIANN = melt(justhefusions)
meltselected_normalizednumericoutputDIANN$variable = factor(meltselected_normalizednumericoutputDIANN$variable , levels = unique(meltselected_normalizednumericoutputDIANN$variable)[length(unique(meltselected_normalizednumericoutputDIANN$variable )):1])
...
pdf("Peptidomics_Results/Peptidomics_results_canon_and_noncanon_split_bygene_GeneFusion.pdf", width = 10, height = 8)
...
for(cont in 1:length(noncanonLabel)){
  ...
  meltselected_normalizednumericoutputDIANN_thisprot = melt(thisselectionandcanon)
